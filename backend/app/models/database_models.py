...
class CampaignPerformance(Base):
    ...
    # Optional SEM Intelligence columns
    search_query = Column(String, index=True, nullable=True)
    ...
    lost_is_budget = Column(Float, nullable=True)
    lost_is_rank = Column(Float, nullable=True)
    avg_position = Column(Float, nullable=True)
    top_impression_share = Column(Float, nullable=True)
    absolute_top_impression_share = Column(Float, nullable=True)
    ...
    target_cpi = Column(Float, nullable=True)
